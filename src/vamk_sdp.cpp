...
void Sdp::startAdvertise(void *uuid, char channel_number, SdpServiceInfo *info)
{
	uint8_t rfcomm_channel = channel_number;

	uuid_t root_uuid, l2cap_uuid, rfcomm_uuid, svc_uuid;
	sdp_list_t *l2cap_list = nullptr, *rfcomm_list = nullptr, *root_list = nullptr;
	sdp_list_t *proto_list = nullptr, *access_proto_list = 0;
	...
	sdp_record_register(_pimpl->session, record, 0);
